...
// The [SmartWallet].
func (inst *Approve) SetSmartWalletAccount(smartWallet ag_solanago.PublicKey) *Approve {
...
// The [SmartWallet].
func (inst *Approve) GetSmartWalletAccount() *ag_solanago.AccountMeta {
	return inst.AccountMetaSlice.Get(0)
}

// SetTransactionAccount sets the "transaction" account.
// The [Transaction].
func (inst *Approve) SetTransactionAccount(transaction ag_solanago.PublicKey) *Approve {
...
// The [Transaction].
func (inst *Approve) GetTransactionAccount() *ag_solanago.AccountMeta {
